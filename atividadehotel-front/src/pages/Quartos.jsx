              ...
              return (
                <tr key={quarto.id}>
                  ...
                  <td className="d-flex flex-column gap-2">
                    {quarto.situacao === "disponível"? <Button className="dark" variant="dark" size="sm" as={Link} to={`/reserva/novo`}>Reservar</Button> : <Button className="danger" variant="danger" size="sm">Indisponível</Button>}
                  </td>
                </tr>
              );
            })}
